...
AsyncStorage.setItem('token',res.data.data).then(res=> navigation.navigate("Tabs")).catch(err=>console.warn(err))
    ...
    return (
        ...
        defaultValue={phone} style={{ borderColor: 'orange', borderWidth: 2, marginVertical: 10, color: 'black', paddingHorizontal: 20 }} placeholder="PHONE NUMBER" placeholderTextColor="gray"></TextInput>
